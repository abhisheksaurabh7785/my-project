...
<a href="#" class="nav-top-item <?php if(in_array($filename,$productmenu)): ?>current<?php endif;?>"> <!-- Add the class "current" to current menu item -->
					...
					<ul>
						...
						<li><a <?php if($filename=='colors.php'):?>class='current'<?php endif;?> href="colors.php">Manage Color</a></li>
						<li><a <?php if($filename=='tags.php'):?>class='current'<?php endif;?> href="tags.php">Manage Tags</a></li>
							<li><a <?php if($filename=='tagsproduct.php'):?>class='current'<?php endif;?> href="tagsproduct.php">Tag Products</a></li>
					</ul>
				</li>
        ...
        <li>
					...
					<ul>
						<li><a href="orders.php" class="">Manage Orders</a></li>
					</ul>
				</li>
